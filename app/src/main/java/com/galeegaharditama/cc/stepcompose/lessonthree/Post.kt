package com.galeegaharditama.cc.stepcompose.lessonthree
...
private val post1 = Post(
  ...
  imageId = commonR.drawable.logo_perki,
  imageThumbId = commonR.drawable.logo_perki,
...
private val post2 = Post(
  ...
  imageId = commonR.drawable.logo_rs,
  imageThumbId = commonR.drawable.logo_rs,
...
private val post3 = Post(
  ...
  imageId = commonR.drawable.logo_univ,
  imageThumbId = commonR.drawable.logo_univ,
  tags = setOf("Kotlin")
)
...
private val post4 = Post(
  ...
  imageId = commonR.drawable.logo_idi,
  imageThumbId = commonR.drawable.logo_idi,
...
private val post5 = Post(
  ...
  imageId = R.drawable.ic_doctor_p,
  imageThumbId = R.drawable.ic_doctor_p,
